import { CancelIcon, UserIcon } from "@/assets/icons";
import Image from "next/image";
const AddNewHouseUnity = ({
  setAddHouseUnity,
}: {
  setAddHouseUnity: (_value: boolean) => void;
}) => {
  return (
    <>
        ...
        <div className="bg-white">
          <div className="text-sm flex justify-between text-white h-50 px-5 py-3 w-full bg-darkColor items-center">
            <h4 className="font-bold text-xl mx-auto">
              House Units Registration
            </h4>
            <button
              className="font-bold text-xl"
              onClick={() => setAddHouseUnity(false)}
            >
            ...
            <div className="grid grid-cols-10     ">
                ...
                <form className="max-w-md mx-auto w-full">
                  <div className="relative z-0 w-full mb-5 group">
                    <select
                      ...
                      required
                    >
                      <option>--Select unity type--</option>
                      <option>room</option>
                      <option>house part</option>
                  ...
                  <div className="relative z-0 w-full mb-5 group">
                    <select
                      ...
                      required
                    >
                      <option>Select the Main House </option>
              ...
              <div className="grid col-span-5 text-gray-700  w-full">
                <div className="block w-full  bg-white  ">
                  <form className="max-w-md mx-auto w-full">
                    <div className="grid md:grid-cols-2 md:gap-6 items-center mt-3 ">
                      <div className="relative z-0 w-full mb-5 group ">
                        <input
                          type="text"
                          name="floating_last_name"
                    ...
                    <div className="relative z-0 w-full mb-5 group">
                      <select
                        ...
                        required
                      >
                        <option>--Select House unity--</option>
...
export default AddNewHouseUnity;
